    ...
    <div className="min-h-[calc(100vh-4rem)] bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white border border-slate-200 rounded-3xl p-8 shadow-xl space-y-6">
        <div className="text-center">
          <div className="w-14 h-14 rounded-2xl bg-purple-100 text-purple-700 flex items-center justify-center mx-auto mb-3 border border-purple-200 shadow-sm">
            <ShieldCheck className="w-7 h-7" />
          </div>
          <h2 className="text-2xl font-black text-slate-900">Admin Portal Login</h2>
          <p className="text-slate-500 text-xs mt-1 font-medium">Product registration & inventory management</p>
        </div>
        ...
        <div className="pt-4 border-t border-slate-100 text-center">
          <Link to="/login/staff" className="text-xs text-emerald-700 hover:underline font-bold">
            Switch to Staff POS Login →
          </Link>
        </div>
      </div>
    </div>
